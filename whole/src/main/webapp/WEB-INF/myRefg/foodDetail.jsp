<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@page import="java.util.*, controller.*, model.dto.*, model.manager.*, model.service.*"%>
...
function deleteFood(postId) {
    var url = '/myRefg/delete?postId=' + postId;
	...
	<div class="wrap">
		<div class="wrap_content_detail">
			...
			<div class="wrap_content_item">
				...
				<form>
				<div class="Group29" style="width: 116px; height: 55px; left: 1334px; top: 490px; position: absolute">
				...
				<div class="Group30" style="width: 116px; height: 55px; left: 1214px; top: 490px; position: absolute">
				<a style="width: 100px; height: 45px; position: absolute; background: #508975; text-align: center; color: white; font-size: 18px;" 
